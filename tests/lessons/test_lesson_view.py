...
from lessons.models import Lesson, Text
from modules.models import Module


@pytest.mark.django_db
def test_lesson_detail_view_access(client, user, course, lesson):
...
@pytest.mark.django_db
def test_lesson_detail_view_permission_denied(client, user, subject):
...
@pytest.mark.django_db
def test_lesson_detail_view_redirect_not_enrolled(client, user, course, lesson):
