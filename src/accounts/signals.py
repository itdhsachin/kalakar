...
def post_save_account_receiver(instance=None, created=False, *args, **kwargs):  # pylint: disable=unused-argument
...
def create_student_profile(sender, instance, created, **kwargs): # pylint: disable=unused-argument
    ...
    ):  # Check if the user is newly created and is a student
...
def create_teacher_profile(sender, instance, created, **kwargs): # pylint: disable=unused-argument
    ...
    ):  # Check if the user is newly created and is a lecturer
