    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ira_rangoli_reference', models.CharField(blank=True, choices=[('WhatsApp', 'WhatsApp'), ('YouTube', 'YouTube'), ('Instagram', 'Instagram'), ('Newspaper', 'Newspaper'), ('Friend', 'Friend')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ira_rangoli_reference', models.CharField(blank=True, choices=[('WhatsApp', 'WhatsApp'), ('YouTube', 'YouTube'), ('Instagram', 'Instagram'), ('Newspaper', 'Newspaper'), ('Friend', 'Friend')], max_length=50)),
                ('hobbies', models.TextField(blank=True)),
                ('last_rangoli_batch_completion_date', models.DateField(blank=True, null=True)),
                ('level_completed', models.CharField(blank=True, choices=[('Basic', 'Basic'), ('Special', 'Special'), ('Advanced', 'Advanced'), ('Professional', 'Professional'), ('Extreme', 'Extreme')], max_length=50, null=True)),
